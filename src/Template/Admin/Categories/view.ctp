...
<div class="categories view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td>
            <?
                var_dump($category->photo);
                var_dump($category->photo_dir);
                echo $this->Html->image($category->photo_dir.$category->photo, ['alt' => 'photo1']);
            ?></td>
        </tr>
        ...
        <?php endif; ?>
            ...
            <?php if (!empty($category->child_categories)): ?>
                ...
                <?php foreach ($category->child_categories as $childCategories): ?>
                    ...
                    <?php if (!empty($childCategories->articles)): ?>

                            <?php foreach ($childCategories->articles as $articles): ?>
                                <?= h($articles->title) ?><br/>
                            <?php endforeach; ?>    
